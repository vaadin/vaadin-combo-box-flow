...
public class OldComboBox<T> extends GeneratedVaadinComboBox<ComboBox<T>, T>
        implements HasSize, HasValidation, HasDataProvider<T>, Serializable {
     ...
     */
    public OldComboBox(String label) {
        this();
        setLabel(label);
    }
     ...
     */
    public OldComboBox(String label, Collection<T> items) {
        this();
        setLabel(label);
        setItems(items);
    }
     ...
     */
    @SafeVarargs
    public OldComboBox(String label, T... items) {
        this();
        setLabel(label);
        setItems(items);
    }
